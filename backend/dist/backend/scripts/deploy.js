...
async function main() {
    ...
    if (chainId == 31337) {
        ...
        let MetaNationsGovTokenArtifact = await hardhat_1.artifacts.readArtifact("MetaNationsGovToken");
        let MetaNationsGovTokenAbi = MetaNationsGovTokenArtifact.abi;
        let AidContractArtifact = await hardhat_1.artifacts.readArtifact("AidContract");
        let AidContractAbi = AidContractArtifact.abi;
        let AirBattleArtifact = await hardhat_1.artifacts.readArtifact("AirBattleContract");
        let airbattleAbi = AirBattleArtifact.abi;
        let AdditionalAirBattleArtifact = await hardhat_1.artifacts.readArtifact("AdditionalAirBattle");
        let additionalairbattleAbi = AdditionalAirBattleArtifact.abi;
        let BillsContractArtifact = await hardhat_1.artifacts.readArtifact("BillsContract");
        let billsAbi = BillsContractArtifact.abi;
        let BombersContractArtifact = await hardhat_1.artifacts.readArtifact("BombersContract");
        let bombersAbi = BombersContractArtifact.abi;
        let BombersMarketplace1Artifact = await hardhat_1.artifacts.readArtifact("BombersMarketplace1");
        let bombersmarketplace1Abi = BombersMarketplace1Artifact.abi;
        let BombersMarketplace2Artifact = await hardhat_1.artifacts.readArtifact("BombersMarketplace2");
        let bombersmarketplace2Abi = BombersMarketplace2Artifact.abi;
        let CountryParametersContractArtifact = await hardhat_1.artifacts.readArtifact("CountryParametersContract");
        let countryParametersAbi = CountryParametersContractArtifact.abi;
        let CrimeContractArtifact = await hardhat_1.artifacts.readArtifact("CrimeContract");
        let crimeAbi = CrimeContractArtifact.abi;
        let CruiseMissileContractArtifact = await hardhat_1.artifacts.readArtifact("CruiseMissileContract");
        let cruiseMissileAbi = CruiseMissileContractArtifact.abi;
        let EnvironmentContractArtifact = await hardhat_1.artifacts.readArtifact("EnvironmentContract");
        let environmentAbi = EnvironmentContractArtifact.abi;
        let FightersContractArtifact = await hardhat_1.artifacts.readArtifact("FightersContract");
        let fightersAbi = FightersContractArtifact.abi;
        let FighterLossesArtifact = await hardhat_1.artifacts.readArtifact("FighterLosses");
        let fighterLossesAbi = FighterLossesArtifact.abi;
        let FightersMarketplace1Artifact = await hardhat_1.artifacts.readArtifact("FightersMarketplace1");
        let fightersmarketplace1Abi = FightersMarketplace1Artifact.abi;
        let FightersMarketplace2Artifact = await hardhat_1.artifacts.readArtifact("FightersMarketplace2");
        ...
        let MissilesContractArtifact = await hardhat_1.artifacts.readArtifact("MissilesContract");
        ...
        let ImprovementsContract1Artifact = await hardhat_1.artifacts.readArtifact("ImprovementsContract1");
        let improvements1Abi = ImprovementsContract1Artifact.abi;
        let ImprovementsContract2Artifact = await hardhat_1.artifacts.readArtifact("ImprovementsContract2");
        let improvements2Abi = ImprovementsContract2Artifact.abi;
        let ImprovementsContract3Artifact = await hardhat_1.artifacts.readArtifact("ImprovementsContract3");
        let improvements3Abi = ImprovementsContract3Artifact.abi;
        let ImprovementsContract4Artifact = await hardhat_1.artifacts.readArtifact("ImprovementsContract4");
        let improvements4Abi = ImprovementsContract4Artifact.abi;
        let InfrastructureContractArtifact = await hardhat_1.artifacts.readArtifact("InfrastructureContract");
        let infrastructureAbi = InfrastructureContractArtifact.abi;
        let InfrastructureMarketplaceArtifact = await hardhat_1.artifacts.readArtifact("InfrastructureMarketContract");
        let infrastructureMarketAbi = InfrastructureMarketplaceArtifact.abi;
        let KeeperContractArtifact = await hardhat_1.artifacts.readArtifact("KeeperContract");
        let keeperAbi = KeeperContractArtifact.abi;
        let LandMarketContractArtifact = await hardhat_1.artifacts.readArtifact("LandMarketContract");
        let landMarketAbi = LandMarketContractArtifact.abi;
        let MilitaryContractArtifact = await hardhat_1.artifacts.readArtifact("MilitaryContract");
        let militaryAbi = MilitaryContractArtifact.abi;
        let NationStrengthContractArtifact = await hardhat_1.artifacts.readArtifact("NationStrengthContract");
        let nationStrengthAbi = NationStrengthContractArtifact.abi;
        let NavyContractArtifact = await hardhat_1.artifacts.readArtifact("NavyContract");
        let navyAbi = NavyContractArtifact.abi;
        let NavyContract2Artifact = await hardhat_1.artifacts.readArtifact("NavyContract2");
        let navy2Abi = NavyContract2Artifact.abi;
        let NavalActionsContractArtifact = await hardhat_1.artifacts.readArtifact("NavalActionsContract");
        let navalActionsAbi = NavalActionsContractArtifact.abi;
        let AdditionalNavyContractArtifact = await hardhat_1.artifacts.readArtifact("AdditionalNavyContract");
        let additionalNavyAbi = AdditionalNavyContractArtifact.abi;
        let NavalBlockadeContractArtifact = await hardhat_1.artifacts.readArtifact("NavalBlockadeContract");
        let navalBlockadeAbi = NavalBlockadeContractArtifact.abi;
        let BreakBlocadeContractArtifact = await hardhat_1.artifacts.readArtifact("BreakBlocadeContract");
        let breakBlockadeAbi = BreakBlocadeContractArtifact.abi;
        let NavalAttackContractArtifact = await hardhat_1.artifacts.readArtifact("NavalAttackContract");
        let navalAttackAbi = NavalAttackContractArtifact.abi;
        let NukeContractArtifact = await hardhat_1.artifacts.readArtifact("NukeContract");
        let nukeAbi = NukeContractArtifact.abi;
        let ResourcesContractArtifact = await hardhat_1.artifacts.readArtifact("ResourcesContract");
        let resourcesAbi = ResourcesContractArtifact.abi;
        let BonusResourcesContractArtifact = await hardhat_1.artifacts.readArtifact("BonusResourcesContract");
        let bonusResourcesAbi = BonusResourcesContractArtifact.abi;
        let SenateContractArtifact = await hardhat_1.artifacts.readArtifact("SenateContract");
        let senateAbi = SenateContractArtifact.abi;
        let SpyContractArtifact = await hardhat_1.artifacts.readArtifact("SpyContract");
        let spycontractAbi = SpyContractArtifact.abi;
        let SpyOperationsContractArtifact = await hardhat_1.artifacts.readArtifact("SpyOperationsContract");
        let spyOperationAbi = SpyOperationsContractArtifact.abi;
        let TaxesContractArtifact = await hardhat_1.artifacts.readArtifact("TaxesContract");
        let taxesAbi = TaxesContractArtifact.abi;
        let AdditionalTaxesContractArtifact = await hardhat_1.artifacts.readArtifact("AdditionalTaxesContract");
        let additionalTaxesAbi = AdditionalTaxesContractArtifact.abi;
        let TechnologyMarketContractArtifact = await hardhat_1.artifacts.readArtifact("TechnologyMarketContract");
        ...
        let Wonders1Artifact = await hardhat_1.artifacts.readArtifact("WondersContract1");
        let wonders1Abi = Wonders1Artifact.abi;
        let Wonders2Artifact = await hardhat_1.artifacts.readArtifact("WondersContract2");
        let wonders2Abi = Wonders2Artifact.abi;
        let Wonders3Artifact = await hardhat_1.artifacts.readArtifact("WondersContract3");
        let wonders3Abi = Wonders3Artifact.abi;
        let Wonders4Artifact = await hardhat_1.artifacts.readArtifact("WondersContract4");
