...
const fundEth = async (taskArgs) => {
    const { nodeAddress, amount } = taskArgs;
    const { ethers } = hardhat_1.default;
    const fundAmount = hardhat_1.default.ethers.utils.parseEther(amount !== null && amount !== void 0 ? amount : "10");
    ...
    const balanceToETH = hardhat_1.default.ethers.utils.formatEther(balance);
