...
describe("Country Minter", function () {
    ...
    describe("Preferences Functions", function () {
        ...
        it("Tests that the setNationName() function reverts correctly", async function () {
            await (0, chai_1.expect)(countryparameterscontract.connect(signer2).setNationName("newNationName", 0)).to.be.revertedWith("!nation owner");
        });
        ...
        it("Tests that the setTeam() function reverts correctly", async function () {
            await (0, chai_1.expect)(countryparameterscontract.connect(signer2).setTeam(0, 0)).to.be.revertedWith("!nation owner");
        });
