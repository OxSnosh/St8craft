...
describe("Country Minter", function () {
    ...
    beforeEach(async function () {
        ...
        if (chainId == 31337) {
            ...
            // }
            fs.writeFileSync(contractMetadataLocation, JSON.stringify(contractMetadata, null, 2));
            ...
            fs.writeFileSync(scriptMetadataLocation, JSON.stringify(scriptMetadata, null, 2));
        }
    });
