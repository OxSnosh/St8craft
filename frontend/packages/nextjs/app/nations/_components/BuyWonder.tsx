...
import { deleteWonder, getWonders } from "~~/utils/wonders";
...
const BuyWonder = () => {
  ...
  const wonderParameters: { [key: string]: { Cost: string; Benefits: string; Requirements: string } } = {
    agricultureDevelopmentProgram: {
      ...
      Benefits:
        "Increases land size by 15%, Increases citizen income +$2.00, Increases citizen-bonus per infrastructure from 8 to 9",
    ...
    nationalEnvironmentalOffice: {
      Cost: "100,000,000 Warbucks",
      Benefits:
        "Removes penalties for Coal, Oil, Uranium; Improves environment +1; Increases population +3%; Reduces infrastructure upkeep -3%",
    ...
    nuclearPowerPlant: {
      ...
      Benefits:
        "+3 happiness with Uranium trade (+1 per 10 tech up to 40 tech), Reduces infra upkeep -5%, Reduces wonder upkeep -5%, Reduces improvement upkeep -5%",
    ...
    scientificDevelopmentCenter: {
      Cost: "150,000,000 Warbucks",
      Benefits:
        "Improves factory infra cost -10%, Improves university citizen income +10%, Great University tech happiness bonus up to 5,000 tech",
    ...
    superiorLogisticalSupport: {
      ...
      Benefits:
        "Reduces aircraft and naval upkeep -10%, Reduces tank upkeep -5%, Increases ground battle strength +10%",
              ...
              <tr key={key} className="border-b border-neutral">
                <Tooltip.Root delayDuration={100}>
                  ...
                  <Tooltip.Portal>
                    ...
                    >
                      <div>
                        <strong>Cost:</strong> {wonderParameters[key]?.Cost || "N/A"}
                      </div>
                      <div>
                        <strong>Benefits:</strong> {wonderParameters[key]?.Benefits || "N/A"}
                      </div>
                      <div>
                        <strong>Requirements:</strong> {wonderParameters[key]?.Requirements || "N/A"}
                      </div>
                    </Tooltip.Content>
                  </Tooltip.Portal>
                </Tooltip.Root>
