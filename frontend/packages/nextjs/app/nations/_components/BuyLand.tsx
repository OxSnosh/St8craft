...
import { buyLand, destroyLand, getAreaOfInfluence, getLandCost, getLandCostPerMile, getLandCount } from "~~/utils/land";
  ...
  return (
    <div className="font-special w-5/6 p-6 bg-aged-paper text-base-content rounded-lg shadow-lg border border-primary">
      ...
      <div className="bg-base-200 p-4 rounded-lg shadow-md">
        ...
        {/* Buy Land Button */}
        {totalCostFromContract !== null && (
          <button onClick={handleBuyLand} className="btn btn-primary w-full mt-4">
      ...
      <div className="bg-base-200 p-4 rounded-lg shadow-md mt-6">
        ...
        />
        <button onClick={() => handleDestroyLand(Number(destroyAmount))} className="btn btn-error w-full mt-4 text-lg">
