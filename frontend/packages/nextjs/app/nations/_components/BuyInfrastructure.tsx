...
const BuyInfrastructure = () => {
  ...
  const handleCalculateCost = async () => {
    ...
    try {
      ...
      const totalCostFromContract = await getInfrastructureCost(
        nationId,
        Number(levelInput),
        publicClient,
  ...
  const handleBuyInfrastructure = async () => {
    ...
    try {
      ...
      const data = contract.interface.encodeFunctionData("buyInfrastructure", [nationId, Number(levelInput)]);
  ...
  return (
    <div className="font-special w-5/6 p-6 bg-aged-paper text-base-content rounded-lg shadow-lg border border-primary">
      ...
      <div className="bg-base-200 p-4 rounded-lg shadow-md">
        ...
        {totalCostFromContract !== null && (
          <button onClick={handleBuyInfrastructure} className="btn btn-primary w-full mt-4">
      ...
      <div className="bg-base-200 p-4 rounded-lg shadow-md mt-6">
        ...
        />
        <button onClick={handleDestroyInfrastructure} className="btn btn-error w-full mt-4">
