...
import { buySoldiers, decommissionSoldiers, getSoldierCost, getSoldierCount } from "~~/utils/forces";
...
const BuySoldiers = () => {
  ...
  const handleBuySoldiers = async (amount: any) => {
    ...
    try {
      ...
      const data = contract.interface.encodeFunctionData("buySoldiers", [Number(amount), nationId]);
  ...
  return (
    <div className="font-special w-5/6 p-6 bg-aged-paper text-base-content rounded-lg shadow-lg border border-primary">
      ...
      <div className="bg-base-200 p-4 rounded-lg shadow-md">
        ...
        {cost !== null && (
          <button onClick={() => handleBuySoldiers(amountInput)} className="btn btn-primary w-full mt-4">
      ...
      <div className="bg-base-200 p-4 rounded-lg shadow-md mt-6">
        ...
        />
        <button onClick={() => handleDecommissionSoldiers(decommissionAmount)} className="btn btn-error w-full text-lg">
