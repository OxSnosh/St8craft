            ...
            rehypeAutolinkHeadings,
            {
              ...
              content: {
                ...
                properties: {
                  ...
                  height: 25,
                  className:
                    "inline-block mr-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200 self-center",
                },
                children: [],
              },
            },
          ...
          h1: ({ node, ...props }) => {
            ...
            return (
              <h1 className="flex items-center gap-2 text-4xl font-bold mt-8 mb-4 group relative" id={id}>
                {props.children}
                {isCopied && <span className="absolute -left-24 text-green-500 text-sm animate-bounce">Copied!</span>}
              </h1>
            );
          },
          h2: ({ node, ...props }) => {
