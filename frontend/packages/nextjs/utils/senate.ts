...
export const sanctionTeamMember = async (
  ...
  try {
    ...
    const tx = await writeContractAsync(...senateContract, "sanctionTeamMember", [senatorId, teamMemberId]);
...
export const liftSanctionVote = async (
  ...
  try {
    const tx = await writeContractAsync(senateContract, "liftSanctionVote", [senatorId, teamMemberId]);
    return tx;
  } catch (error) {
...
export const isSenator = async (nationId: string, SenateContract: any, PublicClient: any) => {
  try {
...
export const isSanctioned = async (idSender: string, idReceiver: string, SenateContract: any, PublicClient: any) => {
  try {
...
export const getSenators = async (SenateContract: any, PublicClient: any, team: string) => {
  try {
...
export const getSenatorVotes = async (SenateContract: any, PublicClient: any, team: string) => {
  try {
