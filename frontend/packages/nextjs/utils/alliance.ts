...
export const assignNationToPlatoon = async (
  ...
  if (!publicClient || !allianceContract || !nationId || !callerNationId || !allianceId || !platoonId) {
    console.error(
      "Missing required data: publicClient, allianceContract, nationId, callerNationId, allianceId, or platoonId.",
    );
    return;
  }
...
export const addAdmin = async (
  ...
  if (!publicClient || !allianceContract || !adminNationId || !callerNationId || !allianceId) {
    console.error(
      "Missing required data: publicClient, allianceContract, adminNationId, callerNationId, or allianceId.",
    );
    return;
  }
...
export const getNationAlliance = async (nationId: string, publicClient: any, allianceContract: any) => {
...
export const getNationAllianceAndPlatoon = async (nationId: string, publicClient: any, allianceContract: any) => {
  if (!publicClient || !allianceContract || !nationId) {
    console.error("Missing required data: publicClient, allianceContract, or nationId.");
    return;
  }
...
export const getAllianceMembers = async (allianceId: string, publicClient: any, allianceContract: any) => {
...
export const getJoinRequests = async (allianceId: string, publicClient: any, allianceContract: any) => {
  if (!publicClient || !allianceContract || !allianceId) {
    console.error("Missing required data: publicClient, allianceContract, or allianceId.");
    return;
  }
...
export const isAdmin = async (allianceId: string, nationId: string, publicClient: any, allianceContract: any) => {
