export const getLandCount = async (nationId: string, publicClient: any, infrastructreContract: any) => {
...
export const getAreaOfInfluence = async (nationId: string, publicClient: any, infrastructreContract: any) => {
  if (!publicClient || !infrastructreContract || !nationId) {
    console.error("Missing required data: publicClient, landContract, or nationId.");
    return;
  }
...
export const getLandCost = async (nationId: string, level: number, publicClient: any, landMarketContract: any) => {
  if (!publicClient || !landMarketContract || !nationId) {
    console.error("Missing required data: publicClient, landMarketContract, or nationId.");
    return;
  }
...
export const getLandCostPerMile = async (nationId: string, publicClient: any, landMarketContract: any) => {
  if (!publicClient || !landMarketContract || !nationId) {
    console.error("Missing required data: publicClient, landMarketContract, or nationId.");
    return;
  }
