export const getTechnologyCount = async (nationId: string, publicClient: any, infrastructureContract: any) => {
...
export const getTechnologyCostPerLevel = async (nationId: string, publicClient: any, technologyMarketContract: any) => {
  if (!publicClient || !technologyMarketContract || !nationId) {
    console.error("Missing required data: publicClient, technologyContract, or nationId.");
    return;
  }
