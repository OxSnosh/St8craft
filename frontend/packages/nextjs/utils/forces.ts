export const getSoldierCount = async (nationId: string, publicClient: any, forcesContracat: any) => {
...
export const getSoldierCost = async (nationId: string, publicClient: any, forcesContracat: any) => {
  if (!publicClient || !forcesContracat || !nationId) {
    console.log(publicClient, "publicClient");
    console.log(forcesContracat, "forcesContracat");
    console.log(nationId, "nationId");
...
export const getDefendingSoldierCount = async (nationId: string, publicClient: any, forcesContracat: any) => {
  if (!publicClient || !forcesContracat || !nationId) {
    console.log(publicClient, "publicClient");
    console.log(forcesContracat, "forcesContracat");
    console.log(nationId, "nationId");
...
export const getDeployedSoldierCount = async (nationId: string, publicClient: any, forcesContracat: any) => {
  if (!publicClient || !forcesContracat || !nationId) {
    console.log(publicClient, "publicClient");
    console.log(forcesContracat, "forcesContracat");
    console.log(nationId, "nationId");
...
export const getTankCount = async (nationId: string, publicClient: any, forcesContracat: any) => {
  if (!publicClient || !forcesContracat || !nationId) {
    console.log(publicClient, "publicClient");
    console.log(forcesContracat, "forcesContracat");
    console.log(nationId, "nationId");
...
export const getTankCost = async (nationId: string, publicClient: any, forcesContracat: any) => {
  if (!publicClient || !forcesContracat || !nationId) {
    console.log(publicClient, "publicClient");
    console.log(forcesContracat, "forcesContracat");
    console.log(nationId, "nationId");
...
export const getMaxTankCount = async (nationId: string, publicClient: any, forcesContracat: any) => {
  if (!publicClient || !forcesContracat || !nationId) {
    console.log(publicClient, "publicClient");
    console.log(forcesContracat, "forcesContracat");
    console.log(nationId, "nationId");
...
export const getDefendingTankCount = async (nationId: string, publicClient: any, forcesContracat: any) => {
  if (!publicClient || !forcesContracat || !nationId) {
    console.log(publicClient, "publicClient");
    console.log(forcesContracat, "forcesContracat");
    console.log(nationId, "nationId");
...
export const getDeployedTankCount = async (nationId: string, publicClient: any, forcesContracat: any) => {
  if (!publicClient || !forcesContracat || !nationId) {
    console.log(publicClient, "publicClient");
    console.log(forcesContracat, "forcesContracat");
    console.log(nationId, "nationId");
...
export const getCasualties = async (nationId: string, publicClient: any, forcesContracat: any) => {
  if (!publicClient || !forcesContracat || !nationId) {
    console.log(publicClient, "publicClient");
    console.log(forcesContracat, "forcesContracat");
    console.log(nationId, "nationId");
