export const getInfrastructureCount = async (nationId: string, publicClient: any, infrastructureContract: any) => {
...
export const getTotalPopulationCount = async (nationId: string, publicClient: any, infrastructureContract: any) => {
  if (!publicClient || !infrastructureContract || !nationId) {
