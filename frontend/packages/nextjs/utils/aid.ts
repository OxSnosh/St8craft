...
export const aidAvailable = (idNation: string, aidContract: any, publicClient: any) => {
...
export const proposalExpired = (idProposal: string, aidContract: any, publicClient: any) => {
  if (!aidContract || !publicClient) {
    console.error("Missing required data: aidContract, publicClient");
    return;
  }
...
export const acceptProposal = (proposalId: string, aidContract: any, writeContractAsync: any) => {
  if (!aidContract || !writeContractAsync) {
    console.error("Missing required data: aidContract, writeContractAsync");
    return;
  }
...
export const cancelAid = (proposalId: string, aidContract: any, writeContractAsync: any) => {
  if (!aidContract || !writeContractAsync) {
    console.error("Missing required data: aidContract, writeContractAsync");
    return;
  }
...
export const getProposalsSent = (idSender: string, aidContract: any, publicClient: any) => {
  if (!aidContract || !publicClient) {
    console.error("Missing required data: aidContract, publicClient");
    return;
  }
...
export const getProposalsReceived = (idReceiver: string, aidContract: any, publicClient: any) => {
  if (!aidContract || !publicClient) {
    console.error("Missing required data: aidContract, publicClient");
    return;
  }
...
export const checkAidSlots = (idNation: string, aidContract: any, publicClient: any) => {
  if (!aidContract || !publicClient) {
    console.error("Missing required data: aidContract, publicClient");
    return;
  }
