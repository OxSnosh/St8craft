export const getTaxesCollectible = async (nationId: string, publicClient: any, taxContract: any) => {
...
export const getDailyIncome = async (nationId: string, publicClient: any, taxContract: any) => {
  if (!publicClient || !taxContract || !nationId) {
    console.log(publicClient, "publicClient");
    console.log(taxContract, "taxContract");
    console.log(nationId, "nationId");
...
export const getTaxRate = async (nationId: string, publicClient: any, infrastructureContract: any) => {
...
export const getTaxablePopulationCount = async (nationId: string, publicClient: any, infrastructureContract: any) => {
  if (!publicClient || !infrastructureContract || !nationId) {
    console.log(publicClient, "publicClient");
    console.log(infrastructureContract, "taxContract");
    console.log(nationId, "nationId");
...
export const getHappiness = async (nationId: string, publicClient: any, taxesContract: any) => {
