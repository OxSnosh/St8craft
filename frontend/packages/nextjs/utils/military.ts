export const getDefconLevel = async (nationId: string, publicClient: any, militaryContract: any) => {
...
export const getThreatLevel = async (nationId: string, publicClient: any, militaryContract: any) => {
  if (!publicClient || !militaryContract || !nationId) {
    console.log(publicClient, "publicClient");
    console.log(militaryContract, "strengthContract");
    console.log(nationId, "nationId");
...
export const getWarPeacePreference = async (nationId: string, publicClient: any, militaryContract: any) => {
  if (!publicClient || !militaryContract || !nationId) {
    console.log(publicClient, "publicClient");
    console.log(militaryContract, "strengthContract");
    console.log(nationId, "nationId");
...
export const getDaysInPeaceMode = async (nationId: string, publicClient: any, militaryContract: any) => {
  if (!publicClient || !militaryContract || !nationId) {
    console.log(publicClient, "publicClient");
    console.log(militaryContract, "strengthContract");
    console.log(nationId, "nationId");
