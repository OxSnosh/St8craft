export const getFighters = async (nationId: string, publicClient: any, fightersContract: any) => {
...
export const getYak9Count = async (nationId: string, publicClient: any, fighterContract: any) => {
...
export const getP51MustangCount = async (nationId: string, publicClient: any, fighterContract: any) => {
  if (!publicClient || !fighterContract || !nationId) {
    console.log(publicClient, "publicClient");
    console.log(fighterContract, "fighterContract");
    console.log(nationId, "nationId");
...
export const getF86SabreCount = async (nationId: string, publicClient: any, fighterContract: any) => {
  if (!publicClient || !fighterContract || !nationId) {
    console.log(publicClient, "publicClient");
    console.log(fighterContract, "fighterContract");
    console.log(nationId, "nationId");
...
export const getMig15Count = async (nationId: string, publicClient: any, fighterContract: any) => {
  if (!publicClient || !fighterContract || !nationId) {
    console.log(publicClient, "publicClient");
    console.log(fighterContract, "fighterContract");
    console.log(nationId, "nationId");
...
export const getF100SuperSabreCount = async (nationId: string, publicClient: any, fighterContract: any) => {
  if (!publicClient || !fighterContract || !nationId) {
    console.log(publicClient, "publicClient");
    console.log(fighterContract, "fighterContract");
    console.log(nationId, "nationId");
...
export const getF35LightningCount = async (nationId: string, publicClient: any, fighterContract: any) => {
  if (!publicClient || !fighterContract || !nationId) {
    console.log(publicClient, "publicClient");
    console.log(fighterContract, "fighterContract");
    console.log(nationId, "nationId");
...
export const getF15EagleCount = async (nationId: string, publicClient: any, fighterContract: any) => {
  if (!publicClient || !fighterContract || !nationId) {
    console.log(publicClient, "publicClient");
    console.log(fighterContract, "fighterContract");
    console.log(nationId, "nationId");
...
export const getSu30MkiCount = async (nationId: string, publicClient: any, fighterContract: any) => {
  if (!publicClient || !fighterContract || !nationId) {
    console.log(publicClient, "publicClient");
    console.log(fighterContract, "fighterContract");
    console.log(nationId, "nationId");
...
export const getF22RaptorCount = async (nationId: string, publicClient: any, fighterContract: any) => {
  if (!publicClient || !fighterContract || !nationId) {
    console.log(publicClient, "publicClient");
    console.log(fighterContract, "fighterContract");
    console.log(nationId, "nationId");
