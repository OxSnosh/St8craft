export const getCruiseMissileCount = async (nationId: string, publicClient: any, missilesContract: any) => {
...
export const getCruiseMissileCost = async (nationId: string, publicClient: any, missilesContract: any) => {
  if (!publicClient || !missilesContract || !nationId) {
    console.error("Missing required data: publicClient, forcesContract, or nationId.");
    return;
  }
