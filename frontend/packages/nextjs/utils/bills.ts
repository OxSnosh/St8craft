export const getBillsPayable = async (nationId: string, publicClient: any, billsContract: any) => {
...
export const calculateDailyBillsFromMilitary = async (nationId: string, publicClient: any, billsContract: any) => {
  if (!publicClient || !billsContract || !nationId) {
    console.error("Missing required data: publicClient, treasuryContract, or nationId.");
    return;
  }
...
export const calculateDailyBillsFromImprovements = async (nationId: string, publicClient: any, billsContract: any) => {
  if (!publicClient || !billsContract || !nationId) {
    console.error("Missing required data: publicClient, treasuryContract, or nationId.");
    return;
  }
