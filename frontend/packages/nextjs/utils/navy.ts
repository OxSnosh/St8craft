export const getNavy = async (nationId: string, publicClient: any, navyContract: any, NavyContract2: any) => {
...
export const getCorvetteCount = async (nationId: string, publicClient: any, navyContract: any) => {
  if (!publicClient || !navyContract || !nationId) {
    console.error("Missing required data: publicClient, navyContract, or nationId.");
    return;
  }
...
export const getLandingShipCount = async (nationId: string, publicClient: any, navyContract: any) => {
  if (!publicClient || !navyContract || !nationId) {
    console.error("Missing required data: publicClient, navyContract, or nationId.");
    return;
  }
...
export const getBattleshipCount = async (nationId: string, publicClient: any, navyContract: any) => {
  if (!publicClient || !navyContract || !nationId) {
    console.error("Missing required data: publicClient, navyContract, or nationId.");
    return;
  }
...
export const getCruiserCount = async (nationId: string, publicClient: any, navyContract: any) => {
  if (!publicClient || !navyContract || !nationId) {
    console.error("Missing required data: publicClient, navyContract, or nationId.");
    return;
  }
...
export const getFrigateCount = async (nationId: string, publicClient: any, NavyContract2: any) => {
...
export const getDestroyerCount = async (nationId: string, publicClient: any, NavyContract2: any) => {
  if (!publicClient || !NavyContract2 || !nationId) {
    console.error("Missing required data: publicClient, navyContract, or nationId.");
    return;
  }
...
export const getSubmarineCount = async (nationId: string, publicClient: any, NavyContract2: any) => {
  if (!publicClient || !NavyContract2 || !nationId) {
    console.error("Missing required data: publicClient, navyContract, or nationId.");
    return;
  }
...
export const getAircraftCarrierCount = async (nationId: string, publicClient: any, NavyContract2: any) => {
  if (!publicClient || !NavyContract2 || !nationId) {
    console.error("Missing required data: publicClient, navyContract, or nationId.");
    return;
  }
