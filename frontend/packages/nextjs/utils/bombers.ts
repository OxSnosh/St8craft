export const getBombers = async (nationId: string, publicClient: any, bomberContract: any) => {
...
export const getAh1CobraCount = async (nationId: string, publicClient: any, bomberContract: any) => {
  if (!publicClient || !bomberContract || !nationId) {
    console.error("Missing required data: publicClient, bomberContract, or nationId.");
    return;
  }
...
export const getAh64ApacheCount = async (nationId: string, publicClient: any, bomberContract: any) => {
  if (!publicClient || !bomberContract || !nationId) {
    console.error("Missing required data: publicClient, bomberContract, or nationId.");
    return;
  }
...
export const getBristolBlenheimCount = async (nationId: string, publicClient: any, bomberContract: any) => {
  if (!publicClient || !bomberContract || !nationId) {
    console.error("Missing required data: publicClient, bomberContract, or nationId.");
    return;
  }
...
export const getB52MitchellCount = async (nationId: string, publicClient: any, bomberContract: any) => {
  if (!publicClient || !bomberContract || !nationId) {
    console.error("Missing required data: publicClient, bomberContract, or nationId.");
    return;
  }
...
export const getB17gFlyingFortressCount = async (nationId: string, publicClient: any, bomberContract: any) => {
  if (!publicClient || !bomberContract || !nationId) {
    console.error("Missing required data: publicClient, bomberContract, or nationId.");
    return;
  }
...
export const getB52StratofortressCount = async (nationId: string, publicClient: any, bomberContract: any) => {
  if (!publicClient || !bomberContract || !nationId) {
    console.error("Missing required data: publicClient, bomberContract, or nationId.");
    return;
  }
...
export const getB2SpiritCount = async (nationId: string, publicClient: any, bomberContract: any) => {
  if (!publicClient || !bomberContract || !nationId) {
    console.error("Missing required data: publicClient, bomberContract, or nationId.");
    return;
  }
...
export const getB1bLancerCount = async (nationId: string, publicClient: any, bomberContract: any) => {
  if (!publicClient || !bomberContract || !nationId) {
    console.error("Missing required data: publicClient, bomberContract, or nationId.");
    return;
  }
...
export const getTupolevTu160Count = async (nationId: string, publicClient: any, bomberContract: any) => {
  if (!publicClient || !bomberContract || !nationId) {
    console.error("Missing required data: publicClient, bomberContract, or nationId.");
    return;
  }
