export const getImprovements = async (
  ...
  if (
    ...
    console.error(
      "Missing required data: publicClient, improvementsContract1, improvementsContract2, improvementsContract3, improvementsContract4, or nationId.",
    );
    return;
  }
...
export const buyImprovement = async (
  ...
  if (
    ...
    console.error(
      "Missing required data: publicClient, improvementContract1, improvementContract2, improvementContract3, improvementContract4, or nationId.",
    );
    return;
  }
