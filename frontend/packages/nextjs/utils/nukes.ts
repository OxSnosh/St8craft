export const buyNukes = async (nationId: string, publicClient: any, missileContract: any, writeContractAsync: any) => {
...
export const getNukeCost = async (nationId: string, publicClient: any, missileContract: any) => {
  if (!publicClient || !missileContract || !nationId) {
    console.log(publicClient, "publicClient");
    console.log(missileContract, "missileContract");
    console.log(nationId, "nationId");
...
export const getNukeCount = async (nationId: string, publicClient: any, missileContract: any) => {
  if (!publicClient || !missileContract || !nationId) {
    console.log(publicClient, "publicClient");
    console.log(missileContract, "missileContract");
    console.log(nationId, "nationId");
