...
export const getCountryCount = async (publicClient: any, countryMinterContract: any) => {
...
export const tokensOfOwner = async (addressOwner: string, publicClient: any, countryMinterContract: any) => {
