export const getSpyCount = async (nationId: string, publicClient: any, spyContract: any) => {
...
export const getSpyPrice = async (nationId: string, publicClient: any, spyContract: any) => {
  if (!publicClient || !spyContract || !nationId) {
    console.log(publicClient, "publicClient");
    console.log(spyContract, "spyContract");
    console.log(nationId, "nationId");
...
export const getMaxSpyCount = async (nationId: string, publicClient: any, spyContract: any) => {
  if (!publicClient || !spyContract || !nationId) {
    console.log(publicClient, "publicClient");
    console.log(spyContract, "spyContract");
    console.log(nationId, "nationId");
