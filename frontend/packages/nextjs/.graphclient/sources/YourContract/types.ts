...
export namespace YourContractTypes {
  ...
  export type SubscriptionSdk = {
    ...
    /** null **/
    cruiseMissileAttack: InContextSdkMethod<
      Subscription["cruiseMissileAttack"],
      SubscriptioncruiseMissileAttackArgs,
      MeshContext
    >;
    /** null **/
    cruiseMissileAttacks: InContextSdkMethod<
      Subscription["cruiseMissileAttacks"],
      SubscriptioncruiseMissileAttacksArgs,
      MeshContext
    >;
    /** null **/
