...
#### updateDesiredGovernment(_uint256 id, uint256 newType_)
...
#### isActiveTrade(_uint256 country1Id, uint256 country2Id_)
...
#### getPlayerResources(_uint256 id_)
...
#### getInfrastructureCostMultiplier1(_uint256 id_)
...
#### getLAndCostPerMile(_uint256 id_)
...
#### destroyTech(_uint256 id, uint256 amount_)
...
#### deleteImprovement1(_uint256 amount, uint256 countryId, uint256 improvementId_)
...
#### deleteWonder1(_uint256 countryId, uint256 wonderId_)
...
#### checkAvailability(_uint256 idSender, uint256 techAid, uint256 balanceAid, uint256 soldierAid_)
...
#### checkCancelledOrAccepted(_uint256 proposalId_)
...
#### getEnvironmentScoreFromMilitaryDensity(_uint256 id_)
...
#### getImprovementPoints(_uint256 id_)
...
#### getStrengthFromBombers(_uint256 id_)
...
#### getStrengthFromNavy(_uint256 id_)
...
#### buySoldiers(_uint256 amount, uint256 id_)
...
#### sendSoldiers(_uint256 idSender, uint256 idReciever, uint256 amount_)
...
#### getMaxDeployablePercentage(_uint256 id_)
...
#### withdrawSoldiers(_uint256 amountToWithdraw, uint256 id_)

This function is only callable from the war contract and will withdraw soldiers from expired wars.

#### decreaseDefendingSoldierCountFromNukeAttack(_uint256 id_)
...
#### getDeployedSoldierEfficiencyModifier(_uint256 id_)
...
#### getDefendingSoldierEfficiencyModifier(_uint256 id_)
...
#### decomissionSoldiers(_uint256 amount, uint256 id_)

This function will allow a nation ruler to decomission defending soldiers.

#### buyTanks(_uint256 amount, uint256 id_)
...
#### withdrawTanks(_uint256 amountToWithdraw, uint256 id_)

This function is only callable from the war contract and will withdraw deployed tanks after a war expires.

#### decreaseDefendingTankCount(_uint256 amount, uint256 id_)
...
#### decreaseDefendingTankCountFromCruiseMissileContract(_uint256 amount, uint256 id_)
...
#### decreaseDefendingTankCountFromNukeContract(_uint256 id_)
...
#### decreaseDefendingTankCountFromAirBattleContract(_uint256 id, uint256 amountToDecrease_)
...
#### decreaseAttackerSpyCount(_uint256 id_)
...
#### decreaseDefenderSpyCount(_uint256 id_)
...
#### decreaseUnits(_uint256 attackerSoldierLosses, uint256 attackerTankLosses, uint256 attackerId, uint256 defenderSoldierLosses, uint256 defenderTankLosses, uint256 defenderId_)
...
#### increaseSoldierCasualties(_uint256 id, uint256 amount_)

This function is used in testing to increase the casualties of a nation.

#### getCasualties(_uint256 id_)
...
#### battleOdds(_uint256 \_warId, uint256 attackerId_)
...
#### groundAttack(_uint256 warId, uint256 attackerId, uint256 defenderId, uint256 attackType_)
...
#### fulfillRequest(_uint256 requestId, uint256[] memory randomWords_)
...
#### trainSpy(_uint256 encryptedAttackerId, uint256 encryptedDefenderId, uint256 attackType_)
...
#### completeSpyTraining(_uint256 \_attackId, bytes encryptedPayload_)
...
#### conductSpyOperation(_uint256 encryptedAttackerId, uint256 defenderId, uint256 \_attackId_)
...
1. getYak9Count(_uint256 id_)
2. getP51MustangCount(_uint256 id_)
3. getF86SabreCount(_uint256 id_)
4. getMig15Count(_uint256 id_)
5. getF100SuperSabreCount(_uint256 id_)
6. getF35LightningCount(_uint256 id_)
7. getF15EagleCount(_uint256 id_)
8. getSu30MkiCount(_uint256 id_)
9. getF22RaptoCount(_uint256 id_)

#### Functions that allow a nation owner to scrap aircraft

1. scrapYak9(_uint256 amount, uint256 id_)
2. scrapP51Mustang(_uint256 amount, uint256 id_)
3. scrapF86Sabre(_uint256 amount, uint256 id_)
4. scrapMig15(_uint256 amount, uint256 id_)
5. scrapF100SuperSabre(_uint256 amount, uint256 id_)
6. scrapF35Lightning(_uint256 amount, uint256 id_)
7. scrapF15Eagle(_uint256 amount, uint256 id_)
8. scrapSu30Mki(_uint256 amount, uint256 id_)
9. scrapF22Raptor(_uint256 amount, uint256 id_)

#### getFighterCount(_uint256 id_)

This function will return the number of fighter aircraft a nations owns.

#### getAircraftCount(_uint256 id_)
...
#### decrementLosses(_uint256[] losses, uint256 id_)
...
1. buyYak9(_uint256 amount, uint256 id_)
2. buyP51Mustang(_uint256 amount, uint256 id_)
3. buyF86Sabre(_uint256 amount, uint256 id_)
4. buyMig15(_uint256 amount, uint256 id_)
5. buyF100SuperSabre(_uint256 amount, uint256 id_)

#### getAircraftPurchaseModifier(_uint256 id_)
...
#### getMaxAircraftCount(_uint256 id_)
...
1. buyF35Lightning(_uint256 amount, uint256 id_)
2. buyF15Eagle(_uint256 amount, uint256 id_)
3. buySu30Mki(_uint256 amount, uint256 id_)
4. buyF22Raptor(_uint256 amount, uint256 id_)
...
#### generateBombers(_uint256 id_)

This function is only callable from the country minter contract. This instantiates the struct of bombers for each nation.

#### Functons that return a nations aircraft count

1. getAh1CobraCount(_uint256 id_)
2. getAh64ApacheCount(_uint256 id_)
3. getBristolBlenheimCount(_uint256 id_)
4. getB52MitchellCount(_uint256 id_)
5. getB17gFlyingFortressCount(_uint256 id_)
6. getB52StratofortressCount(_uint256 id_)
7. getB2SpiritCount(_uint256 id_)
8. getB1bLancerCount(_uint256 id_)
9. getTupolevTu160Count(_uint256 id_)

#### Functions that allow a nation owner to scrap aircraft

1. scrapAh1Cobra(_uint256 amount, uint256 id_)
2. scrapAh64Apache(_uint256 amount, uint256 id_)
3. scrapBristolBlenheim(_uint256 amount, uint256 id_)
4. scrapB52Mitchell(_uint256 amount, uint256 id_)
5. scrapB17gFlyingFortress(_uint256 amount, uint256 id_)
6. scrapB52Stratofortress(_uint256 amount, uint256 id_)
7. scrapB2Spirit(_uint256 amount, uint256 id_)
8. scrapB1bLancer(_uint256 amount, uint256 id_)
9. scrapTupolevTu160(_uint256 amount, uint256 id_)

#### getBomberCount(_uint256 id_)

This function will return the number of bomber aircraft a nations owns.

#### decrementBomberLosses(_uint256[] memory losses, uint256 id_)
...
1. buyAh1Cobra(_uint256 amount, uint256 id_)
2. buyAh64Apache(_uint256 amount, uint256 id_)
3. buyBristolBlenheim(_uint256 amount, uint256 id_)
4. buyB52Mitchell(_uint256 amount, uint256 id_)
5. buyB17gFlyingFortress(_uint256 amount, uint256 id_)
...
1. buyB52Stratofortress(_uint256 amount, uint256 id_)
2. buyB2Spirit(_uint256 amount, uint256 id_)
3. buyB1bLancer(_uint256 amount, uint256 id_)
4. buyTupolevTu160(_uint256 amount, uint256 id_)
...
#### airBattle(_uint256 warId, uint256 attackerId, uint256 defenderId, uint256[] memory attackerFighterArray, uint256 memory attackerBomberArray_)
...
#### completeAirBattle(_uint256[] memory attackerFighterCasualties, uint256[] memory attackerBomberCasualties, uint256[] memory defenderFighterCasualties, uint256 attackerId, uint256 defenderId, uint256 infrastructureDamage, uint256 tankDamage, uint256 cruiseMissileDamage_)
...
#### buyCruiseMissiles(_uint256 amount, uint256 id_)
...
#### getCruiseMissileCount(_uint256 id_)

This function will return a given nations cruise missile count.

#### decreaseCruiseMissileCount(_uint256 amount, uint256 id_)
...
#### decreaseCruiseMissileCountFromNukeContract(_uint256 id_)
...
#### updateDefaultNukePurchaseCost(_uint256 newCost_)
...
#### decreaseNukeCountFromSpyContract(_uint256 id_)
...
#### launchNuke(_uint256 warId, uint256 attackerId, uint256 defenderId, uint256 attackType_)
...
#### getThwartOdds(_uint256 attackerId, uint256 defendrId_)
...
#### inflictNukeDamage(_uint256 attackId_)
...
#### updateGlobalRadiationModifier(_uint256 newModifier_)
...
#### launchCruiseMissileAttack(_uint256 attackerId, uint256 defenerId, uint256 warId_)
...
#### destroyTanks(_uint256 attackId_)
...
#### destroyTech(_uint256 attackId_)
...
#### destroyInfrastructure(_uint256 attackId_)
